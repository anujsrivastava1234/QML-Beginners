...
Window {
    ...
    Component.onCompleted: {
        ...
        console.log("The property of mUrl is:" + mUrl)
        ...
        console.log("The componentns of aRect are x:" + aRect.x + " ,y: " + aRect.y + ", width: " + aRect.width + " , height: " + aRect.height)
